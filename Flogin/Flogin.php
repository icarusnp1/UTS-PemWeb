	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('air.png');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" method="post" action="../Sistem/ceklogin.php" autocomplete="off">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input class="input100" type="password" name="password" placeholder="Password" autocomplete="new-password" value="">
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
					</div>
					...
					<div class="container-login100-form-btn m-t-32">
						...
						<a href="Fregister.php" class="login100-form-btn">
							Register
						</a>
					</div>
