  ...
  <div class="container-login100">
    <div class="container">
      <div class="table-title" >Add user</div>
        <div class="mb-3">
      <form method="post" action="../Sistem/tambah.php">
        <table  class="table">
          <tr>
            <td>Name</td>
            <td>
              <input type="hidden" name="status_aktif" value="Y">
              <input type="hidden" name="status_pembayaran" value="">
          ...
          <tr>
            <td>Date acctive</td>
            <td><input type="date" name="tanggal_penggunaan"></td>
          </tr>
          <tr>
            <td colspan=3>
